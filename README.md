...
*Note: Once booted into the Automotive Launcher, lock the display to landscape:*
```bash
...
### 7. System Server & Crash Loop Protection
...
# 2. Flash images with AVB verification disabled
fastboot --disable-verity --disable-verification flashall -w
# 3. Reboot into AAOS 17
fastboot reboot
```
